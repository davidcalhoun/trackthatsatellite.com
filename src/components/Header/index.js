		...
		<Autocomplete
			...
			renderInput={params => (
				<StyledTextField
					{...params}
					label="Satellite"
					variant={ breakpoint >= 7 ? "outlined" : "filled" }
					fullWidth
				/>
			)}
		...
		<header className={styles.container}>
			...
			<nav className={styles.nav}>
				<ul>
					<li>
						<Link to="/map" replace>
							<StyledNavButton variant="contained" color={ currentView === "map" ? "primary" : "default" }>
					...
					<li>
						<Link to="/visible-satellites-overhead" replace>
							<StyledNavButton variant="contained" color={ currentView === "overhead" ? "primary" : "default" }>
